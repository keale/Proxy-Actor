...
<Library LVVersion="14008000">
	...
	<Item Name="Messages for this Actor" Type="Folder">
		<Item Name="Alice Action Msg.lvclass" Type="LVClass" URL="../Alice Messages/Alice Action Msg/Alice Action Msg.lvclass"/>
		<Item Name="Proceed connection state Msg.lvclass" Type="LVClass" URL="../Alice Messages/Proceed connection state Msg/Proceed connection state Msg.lvclass"/>
		<Item Name="Proceed failed Msg Msg.lvclass" Type="LVClass" URL="../Alice Messages/Proceed failed Msg Msg/Proceed failed Msg Msg.lvclass"/>
		<Item Name="Write Bob Enq Msg.lvclass" Type="LVClass" URL="../Alice Messages/Write Bob Enq Msg/Write Bob Enq Msg.lvclass"/>
	</Item>
	<Item Name="Alice.lvclass" Type="LVClass" URL="../Alice/Alice.lvclass"/>
</Library>
